  ...
  return (
    <article className="px-10 pb-28  text-black dark:text-white">
      ...
      <div className="w-64  text-black dark:text-white">
          ...
          {student.filter(student=>student.enrollment_no==200220131112).map(student=>{ 
	...
	<img src={student.img} alt="" className="w-32 h-32 mx-auto  dark:bg-gray-500 aspect-square" />
	<div className="space-y-4 text-center divide-y divide-gray-700">
		<div className="my-2 space-y-1">
			<h2 className="text-xl font-semibold sm:text-2xl">{student.student_Name}</h2>
			<p className="px-5 text-xs sm:text-base dark:text-gray-400">{student.enrollment_no}</p>
      <p className="px-5 text-xs sm:text-base dark:text-gray-400">{student.semester}</p>
      <p className="px-5 text-xs sm:text-base dark:text-gray-400">{student.company_name}</p>
      <p className=" inline-block bg-gray-200 rounded-full dark:bg-white   py-1 px-5 text-xs sm:text-base dark:text-black">{student.package}</p>
