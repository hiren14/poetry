...
{/* <div className="px-6 py-4"> */}
  {poems.filter(poems=>poems.id==num1).map(poems=>{ 
      ...
      <h2 style={{whiteSpace: 'pre-line'}} className="text-center text-xl font-semibold sm:text-2xl">{poems.Title}</h2><br /><hr  className="bg-[#8F00FF]" />
...
<h2>poem no  is: {num}</h2><br />

            <button
            
            className= "center bg-blue-800 dark:bg-[#8F00FF] hover:bg-blue-700 dark:text-black text-white font-bold py-2 px-4 rounded-full"
            onClick={handleClick}>
